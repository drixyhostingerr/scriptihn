...
if [ "${EUID}" -ne 0 ]; then
		echo "Kamu Butuh Akses root Untuk Instal Script"
  sleep 5
		exit 1
fi
if [ "$(systemd-detect-virt)" == "openvz" ]; then
		echo "OpenVZ Tidak supported"
  clear
                echo "Untuk VPS KVM Dan VMWare virtualization Saja"
  sleep 5
		exit 1
fi
...
wget https://raw.githubusercontent.com/drixyhostingerr/scriptihn/main/ssh/cf && chmod +x cf && ./cf
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/drixyhostingerr/scriptihn/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/drixyhostingerr/scriptihn/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/drixyhostingerr/scriptihn/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/drixyhostingerr/scriptihn/main/menu/versi  )
...
echo "----------------------IHN INDONESIA-------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
